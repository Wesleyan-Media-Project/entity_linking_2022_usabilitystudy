...
# Output files
path_ner_4k_prepared <- "facebook/validation/ner_linking_sample_4k_separate.csv"


df <- fread(path_ner_3k, colClasses = "character", encoding = "UTF-8")
...
df3 <- df2 %>%
  select(page_name, disclaimer, ad_creative_body, 
